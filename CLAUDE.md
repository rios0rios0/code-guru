...
In the YAML path (`NewSettings`), env vars override YAML only for: trivial settings, `bot_identities`, `ai.max_attempts`, `ai.project_guidelines`, and `ai.pr_metadata`.
